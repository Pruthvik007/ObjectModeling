...
public class ContestService implements IContestService {
    ...
    List<Question> selectedQuestions = new ArrayList<>();
     while(selectedQuestions.size()!=numQuestion) {
        Question selectedQuestion=questions.get((int)Math.random()*questions.size());
    ...
    public List<Contest> getAllContestLevelWise(Level level) {
     ...
     return this.contestRepository.findAllContestLevelWise(level);
    }
