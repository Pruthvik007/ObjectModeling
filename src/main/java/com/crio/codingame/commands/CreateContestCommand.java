...
public class CreateContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        try {
            if(tokens.size()==5){
                System.out.print(contestService.create(tokens.get(1), Level.valueOf(tokens.get(2)), tokens.get(3),Integer.parseInt(tokens.get(4))));
            } else {
                System.out.print(contestService.create(tokens.get(1), Level.valueOf(tokens.get(2)), tokens.get(3),null));
            }
        } catch (Exception e){
