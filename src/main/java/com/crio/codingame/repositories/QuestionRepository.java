...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
        return this.questionMap.entrySet().stream().map(entry->entry.getValue()).collect(Collectors.toList());
    }
    ...
    public boolean existsById(String id) {
        return this.questionMap.containsKey(id) ? true : false;
    }

    @Override
    public void delete(Question entity) {
        this.questionMap.remove(entity.getId());
    }

    @Override
    public void deleteById(String id) {
        this.questionMap.remove(id);
    }
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
     return this.questionMap.entrySet().stream().filter(entry->entry.getValue().getLevel().equals(level)).map(entry->entry.getValue()).collect(Collectors.toList());
    }
